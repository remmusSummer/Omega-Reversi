...
class PolicyValueNet():
    ...
    def _loss_train_op(self):
        ...
        value_loss = keras.losses.mean_squared_error(self.winner, self.value_net.output.flatten())
        policy_loss = keras.losses.categorical_crossentropy(self.policy_net.output, self.mcts_probs)
...
if __name__ == '__main__':
    training_pipeline = PolicyValueNet()
